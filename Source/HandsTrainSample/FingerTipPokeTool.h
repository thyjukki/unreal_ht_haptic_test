...
public:
	...
	virtual void Initialize_Implementation(UOculusHandComponent *HandComponent)
		override;
...
protected:
	...
	TArray<FOculusCapsuleCollider> CollisionCapsulesForBone;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Tool Properties")
	UOculusHandComponent* HandToTrack;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Tool Properties")
	FOculusCapsuleCollider CapsuleToTrack;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Tool Properties")
	EBone BoneToTestCollisions;
