...
UENUM(BlueprintType)
enum class EHandsVisualMode : uint8
{
	Mesh,
	Skeleton,
	Both,
...
protected:
	...
	UOculusHandComponent *LeftHand;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Hands")
	UOculusHandComponent *RightHand;

	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Visual")
	EHandsVisualMode CurrentVisualMode;
...
private:
	...
	void InitVisualsPerHand(UOculusHandComponent *Hand);
